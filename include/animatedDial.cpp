...
byte DIAL_CENTRE_Y = 120;
byte DIAL_CENTRE_X = 120;
byte NEEDLE_LENGTH = 35;
byte NEEDLE_WIDTH = 5;
byte NEEDLE_RADIUS = 90;
byte DIAL_POSITION_X =0;
byte DIAL_POSITION_Y = 0;
...
{
  // Draw the dial
  TJpgDec.drawJpg(DIAL_POSITION_X,DIAL_POSITION_Y, dial, sizeof(dial));
